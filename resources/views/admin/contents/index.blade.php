          ...
          <div class="col-lg-12">
            <section class="panel">
              <header class="panel-heading">
               ...
               <p class="apsd"> <a href="form_contents.php" class="btn btn-primary" style="font-size: 30px; ">เพิ่มข้อมูล</a> </p>
                ...
                <table class="table">
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td>Table cell</td>
                      <td>Table cell</td>
                      <td><a href="form_edit_contents.php" class="btn btn-warning">แก้ไขข้อมูล</a></td>
